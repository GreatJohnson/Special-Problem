...
class Scan_msg:
	...
	self.dbgmsg = {0:'Move forward',1:'Veer right',10:'Veer right',11:'Veer right',10000:'Veer left',10100:'Veer left',11000:'Veer left',11100:'Veer right'}
	...
	for entry in range(0,entries):
		...
		self.sect_2 = 1 if (entries/5 < entry < entries/4) else 0
		self.sect_3 = 1 if (entries/4 < entry < entries/3) else 0		
		self.sect_4 = 1 if (entries/3 < entry < entries/2) else 0		
		self.sect_5 = 1 if (entries/2 < entry < entries) else 0
